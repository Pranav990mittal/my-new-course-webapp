...
//                 "/courses"
//               }
//               className="bg-green-500 py-3 px-6 text-white rounded font-semibold hover:bg-white duration-300 hover:text-black"
//             >
//               Explore Courses
//             </Link>
//             <Link
//               to={"https://www.youtube.com/@GateSmashers/courses"}
//               target="_blank"
//               className="bg-white py-3 px-6 text-black rounded font-semibold hover:bg-green-500 duration-300 hover:text-white"
//             >
//               Courses Videos
//             </Link>
//           </div>
...
//                 <div className="relative flex-shrink-0 max-w-xs mx-auto transition-transform duration-300 transform hover:scale-105">
...
//                     target="_blank"
//                   >
//                     <FaLinkedin className="text-2xl hover:text-blue-400 duration-300" />
//                   </a>
//                 </div>
//               </div>
//             </div>

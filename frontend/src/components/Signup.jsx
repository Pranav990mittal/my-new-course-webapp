...
// import logo from "../../public/logo.webp"; // Adjust path if needed
...
//                   className="w-full px-3 py-2 rounded bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-orange-500"
//                 />
//               </div>
//               <div>
//                 <label className="block text-sm font-medium text-gray-300 mb-1">
...
//               <button
//                 type="submit"
//                 className="w-full py-2 rounded bg-orange-500 text-white font-semibold hover:bg-blue-600 transition"
//               >
//                 Signup
//               </button>
//             </form>
